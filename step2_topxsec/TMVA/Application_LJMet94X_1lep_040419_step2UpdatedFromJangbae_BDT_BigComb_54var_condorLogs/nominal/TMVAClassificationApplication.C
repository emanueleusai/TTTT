...
{   
   ...
   reader->AddVariable( "corr_met_singleLepCalc", &var25 );
   reader->AddVariable( "leptonPt_singleLepCalc", &var26 );
   ...
   reader->AddVariable( "deltaR_lepbJetInMinMlb", &var43 );
   reader->AddVariable( "M_allJet_W", &var44 );
   reader->AddVariable( "HT_bjets", &var45 );
   reader->AddVariable( "ratio_HTdHT4leadjets", &var46 );
   reader->AddVariable( "csvJet3", &var47 );
   reader->AddVariable( "csvJet4", &var48 );
   reader->AddVariable( "thirdcsvb_bb", &var49 );
   reader->AddVariable( "fourthcsvb_bb", &var50 );
   reader->AddVariable( "NJets_JetSubCalc", &var51 );
   reader->AddVariable( "HT_2m", &var52 );
   reader->AddVariable( "Sphericity", &var53 );
   reader->AddVariable( "Aplanarity", &var54 );

   // --- Book the MVA methods

   // Book method(s)
   reader->BookMVA( "BDT method", "/user_data/jlee/TTTT/CMSSW_9_4_6_patch1/src/step2_topxsec/TMVA/dataset/weights/BDT_BigComb_54vars_mDepth3/TMVAClassification_BDT.weights.xml" );
   ...
   theTree->SetBranchAddress( "corr_met_singleLepCalc", &var25 );
   theTree->SetBranchAddress( "leptonPt_singleLepCalc", &var26 );
   ...
   theTree->SetBranchAddress( "deltaR_lepbJetInMinMlb", &var43 );
   theTree->SetBranchAddress( "M_allJet_W", &var44 );
   theTree->SetBranchAddress( "HT_bjets", &var45 );
   theTree->SetBranchAddress( "ratio_HTdHT4leadjets", &var46 );
   theTree->SetBranchAddress( "csvJet3", &var47 );
   theTree->SetBranchAddress( "csvJet4", &var48 );
   theTree->SetBranchAddress( "thirdcsvb_bb", &var49 );
   theTree->SetBranchAddress( "fourthcsvb_bb", &var50 );
   theTree->SetBranchAddress( "NJets_JetSubCalc", &var51 );
   theTree->SetBranchAddress( "HT_2m", &var52 );
   theTree->SetBranchAddress( "Sphericity", &var53 );
   theTree->SetBranchAddress( "Aplanarity", &var54 );

...
{   
   ...
   Float_t var2;
   Float_t var3;
   reader->AddVariable( "AK4HT", &var1 );
   reader->AddVariable( "centrality", &var2 );
   reader->AddVariable( "FW_momentum_2", &var3 );

   // --- Book the MVA methods

   // Book method(s)
   reader->BookMVA( "BDT method", "/user_data/jlee/TTTT/CMSSW_9_4_6_patch1/src/TMVA/dataset/weights/BDT_BigComb_3vars_mDepth2/TMVAClassification_BDT.weights.xml" );
   ...
   theTree->SetBranchAddress( "AK4HT", &var1 );
   theTree->SetBranchAddress( "centrality", &var2 );
   theTree->SetBranchAddress( "FW_momentum_2", &var3 );

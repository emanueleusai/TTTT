...
for sample in sorted(nRun.keys()):
    #if 'TTJetsHad' or 'TTJets2L' or 'TTJetsSemi' or 'TTJetsPH' in sample:
    if 'TTJetsHad'  in sample or 'TTJets2L' in sample or 'TTJetsSemi' in sample or 'TTJetsPH' in sample or '4TM690' in sample: #Note from bjorn you have to do if A in sample or B in sample or C in cample, not A or B or C in sample
        print 'sample, weight:', sample, weight[sample]
#  LocalWords:  nRun
